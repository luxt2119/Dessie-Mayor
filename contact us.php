...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!-- TITLE OF SITE -->
        <title>Dessie City Adminstration(contact)</title>
									...
									<div class="contact-right">
										<div class="contact-adress">
											<div class="contact-office-address">
												<h3>contact info</h3>
												<p>
													shel, Dessie, South Wollo, Amhara, Ethiopia
												</p>
												<div class="contact-online-address">
													...
													<div class="single-online-address">
														...
														<span>yalemwas.mohammed32"@gmail.com</span>
													</div><!--/.single-online-address-->
 ...
 ?>
										...
										<div class="">
												<div class="col-sm-6 col-xs-12">
													...
													<label for="fullname" >full name</lebel>	
														<input type="text" class="form-control" id="email" placeholder="full name" name="fullname">
													</div><!--/.form-group-->
												</div><!--/.col-->
											...
											<div class="row">
												...
												<div class="col-sm-6 col-xs-12">
													<div class="form-group">
													<label for="phone" >Phone number</lebel>	
											...
											<div class="col-sm-6 col-xs-12">
													<div class="form-group">
													<label for="subject" >Subject</lebel>	
													  <input type="text" class="form-control" id="lastname" placeholder="subject" name="subject">
													</div><!--/.form-group-->
												</div><!--/.col-->
												<div class="col-sm-12">
													<div class="form-group">
													<label for="Message" >Message</lebel>	
														<textarea class="form-control" rows="7" id="comment" placeholder="Message" name="message"></textarea>
													</div><!--/.form-group-->
												</div><!--/.col-->
											</div><!--/.row-->
											<div class="row">
												<div class="col-sm-12">
													<div class="single-contact-btn pull-right">
														<input class="btn btn-primary btn-block" type="submit" name="submitForm" value="submit">
